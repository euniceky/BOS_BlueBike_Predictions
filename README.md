...
In "clean_process_triphistory.ipynb", Bluebikes trip history from August 2017 to July 2019 are used to compute the average number of trips per month per existing bike station. 
